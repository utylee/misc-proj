...
# 해당 주소와 패턴을 정의합니다
url = "https://www.fedex.com/apps/fedextrack/?tracknumbers=725357554059&cntry_code=kr"
#patt = '예약 : (.*)명 / 좌'
patt = 'date_time\"'
...
class FetchReservers():
    def __init__(self):
        self.url = "https://www.fedex.com/apps/fedextrack/?tracknumbers=725357554059&cntry_code=kr"
        self.patt = 'date_time\"'
        self.file_name = 'current_fedex.dat'
        self.current_num = 0
    ...
    def fetchurl(self):
        ...
        #elem = phantom_drv.find_element_by_class_name("date_time")
        elem = phantom_drv.find_element_by_class_name("info_icon_column")
